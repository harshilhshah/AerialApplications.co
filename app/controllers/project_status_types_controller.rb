class ProjectStatusTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @project_status_type.save
        ...
        format.json { render :show, status: :created, location: @project_status_type }
      else
  ...
  def update
    respond_to do |format|
      if @project_status_type.update(project_status_type_params)
        ...
        format.json { render :show, status: :ok, location: @project_status_type }
      else
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to project_status_types_url, notice: 'Project status type was successfully destroyed.' }
  ...
  private
    ...
    def project_status_type_params
      params.require(:project_status_type).permit(:description, :name)
    end
end
