...
class ReferralsControllerTest < ActionController::TestCase
  ...
  test "should create referral" do
    assert_difference('Referral.count') do
      post :create, referral: { referredUserId: @referral.referredUserId, referringUserId: @referral.referringUserId }
    end
  ...
  test "should update referral" do
    patch :update, id: @referral, referral: { referredUserId: @referral.referredUserId, referringUserId: @referral.referringUserId }
    assert_redirected_to referral_path(assigns(:referral))
  end
