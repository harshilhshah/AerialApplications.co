...
class ProjectStatusesControllerTest < ActionController::TestCase
  ...
  test "should create project_status" do
    assert_difference('ProjectStatus.count') do
      post :create, project_status: { comment: @project_status.comment, owner: @project_status.owner, projectId: @project_status.projectId, statusId: @project_status.statusId }
    end
  ...
  test "should update project_status" do
    patch :update, id: @project_status, project_status: { comment: @project_status.comment, owner: @project_status.owner, projectId: @project_status.projectId, statusId: @project_status.statusId }
    assert_redirected_to project_status_path(assigns(:project_status))
  end
